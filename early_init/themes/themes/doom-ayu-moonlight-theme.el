...
;;
(defgroup doom-ayu-moonlight-theme nil
  "Options for the `doom-ayu-moonlight' theme."
  :group 'doom-themes)
...
(def-doom-theme doom-ayu-moonlight
  "Inspired by doom-ayu-mirage and doom-moonlight"
