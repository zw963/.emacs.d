...
;;;###autoload
(define-derived-mode scss-css-mode css-mode "SCSS"
...
(define-key scss-css-mode-map "\C-c\C-c" 'scss-compile)
...
(push '(".+\\.scss$" flymake-scss-init) flymake-proc-allowed-file-name-masks)
...
;;;###autoload
(add-to-list 'auto-mode-alist '("\\.scss\\'" . scss-css-mode))

(provide 'scss-css-mode)
