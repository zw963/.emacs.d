...
(add-hook 'treemacs-mode-hook
          (lambda ()
            ...
            ;; 这个只能在这个文件中定义, 在其他文件中使用 with-eval-after-load 'treemacs 不工作, 不知道为什么.
            (define-key treemacs-mode-map [mouse-3]         'treemacs-rightclick-menu-bc3-hacked)
            ))


(defun treemacs-rightclick-menu-bc3-hacked (event)
