...
;; C-; 开启 iedit, TAB/Shift+TAB 在所有发生中跳转。
(require 'iedit)
...
(define-key iedit-mode-occurrence-keymap [(meta p)] 'iedit-prev-occurrence)
(define-key iedit-mode-occurrence-keymap [(meta n)] 'iedit-next-occurrence)
