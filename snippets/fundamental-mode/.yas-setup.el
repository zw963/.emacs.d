...
(yas-define-condition-cache yas-in-interpolated-string-p (member (cl-fourth (syntax-ppss)) (list ?\" ?\` ?/)))
(yas-define-condition-cache yas-in-string-p (cl-fourth (syntax-ppss)))
(yas-define-condition-cache yas-not-in-string-p (not (cl-fourth (syntax-ppss))))
(yas-define-condition-cache yas-in-comment-p (cl-fifth (syntax-ppss)))
(yas-define-condition-cache yas-in-string-or-comment-p (or (cl-fourth (syntax-ppss)) (cl-fifth (syntax-ppss))))
